            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>Welcome to Our Maangalya Shopping Mall</li>
                                <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: 123 - 456 - 7890</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <ul class="header-dropdown">
                            ...
                            <li class="onhover-dropdown mobile-account"> <i class="fa fa-user" aria-hidden="true"></i>
                                ...
                                <ul class="onhover-show-div">
                                    <li><a href="/login.aspx" data-lng="en">Login</a></li>
                                    <li><a href="/Registration.aspx" data-lng="es">Registration</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
 ...
 <div class="icon-nav">
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="../assets/images/home-banner/rahul.jpeg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
    ...
    <section class="pb-0 ratio2_1">
        <div class="container">
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="CategoryPage.aspx">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/sub-banner1.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                ...
                <div class="col-md-6">
                    <a href="WomensCategory.aspx">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/sub-banner2.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href=""><img src="../assets/27.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href=""><img src="../assets/28.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="">
                                        <img src="../assets/29.jpg" class="img-fluid blur-up lazyload bg-img"
                                            alt=""></a>
                                </div>
                                <div class="back">
                                    <a href=""><img src="../assets/30.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on
                                        sale</span></div>
                                <div class="front">
                                    <a href=""><img src="../assets/33.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href=""><img src="../assets/34.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href=""><img src="../assets/35.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href=""><img src="../assets/36.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="../assets/1.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog1/1.jpg" class="img-fluid blur-up lazyload bg-img"
                                            alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog1/2.jpg" class="img-fluid blur-up lazyload bg-img"
                                            alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog1/3.jpg" class="img-fluid blur-up lazyload bg-img"
                                            alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog1/4.jpg" class="img-fluid blur-up lazyload bg-img"
                                            alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog1/5.jpg" class="img-fluid blur-up lazyload bg-img"
                                            alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/2.jpg" class="bg-img"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/3.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/4.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/9.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/6.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/7.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="../assets/images/slider1/8.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="form-group mx-sm-3">
                                    <input type="text" class="form-control" id="email" name="EMAIL2" runat="server" 
                                        placeholder="Enter your email" required="required">
                                </div>
                              
                           <button type="submit" class="btn btn-solid" onclick="unloadEvents" runat="server" >subscribe</button>
    ...
    <!--modal popup start-->
    <div class="modal fade bd-example-modal-lg theme-modal" runat="server" id="exampleModal" tabindex="-1" role="dialog"
        aria-hidden="true">
                                        ...
                                        <h2>newsletter</h2>
                                           ...
                                           <form>
                                            <div class="form-group mx-sm-3">
                                                 ...
                                                 <input type="text" class="form-control" id="Text2" name="EMAIL2" runat="server" 
                                        placeholder="Enter your email" required="required">


                                            
                                                <button type="submit" class="btn btn-solid" onclick="loadEvents" runat="server" >subscribe</button>
                                                </div>
                                           </form>                                             
                                    </div>
                                </div>
