        ...
        <div class="body">
            ...
            <asp:Button ID="btnHide" runat="server" Text="Close" />
                                        ...
                                        <div class="form-group">
                                            <input required="" name="MobileNumber" type="text" class="form-control" placeholder="Mobile Number" id="exampleInputEmail1" maxlength="10">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-button">
                                              <asp:Button ID="btn_Submit" CssClass="btn btn-primary" onclick="Submit_Click" runat="server" Text="Submit" />
