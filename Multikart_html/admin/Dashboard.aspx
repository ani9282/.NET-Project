                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <!--<li><a href="Category-digitalsub.html"><i class="fa fa-circle"></i>Chapter Master</a></li>-->
                                     <!-- <li><a href="add-product.aspx"><i class="fa fa-circle"></i>Chapter Master</a></li>
                                    <!--<li><a href="Product-listdigital.html"><i class="fa fa-circle"></i>Upload Question</a></li>-->
                                    ...
                                    <li><a href="add-product.aspx"><i class="fa fa-circle"></i>Add Product</a></li>
                                     <li><a href="BulkUpload.aspx"><i class="fa fa-circle"></i>Bulk Upload</a></li>-->
