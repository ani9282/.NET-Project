            ...
            <div class="container-fluid">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Menu Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName" runat="server" Text='<%#Eval("Menuname") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Status">
                        <ItemTemplate>
                              <asp:Label ID="lblFullName2" runat="server" Text='<%#Eval("Flag") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Created ON">
                        <ItemTemplate>
                              <asp:Label ID="lblFullName1" runat="server" Text='<%#Eval("Created_On") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Place ">
                        <ItemTemplate>
                              <asp:Label ID="lblFullName9" runat="server" Text='<%#Eval("Visibility") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                           
                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("Menuid") %>' runat="server">Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
