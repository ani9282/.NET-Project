<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Updateproduct.aspx.cs" Inherits="admin_Updateproduct" %>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Products Category Master</h5>
                            </div>
                            <div class="card-body">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <div class="form">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="validationCustom01" name="product" value="<% =ServerValue %>" type="text">
                                                            </div>
                                                             <div class="form-group">
                                                                <label for="validationCustom01" class="mb-1">Category :</label>
                                                                <input class="form-control" id="validationCustom02" name="category" value="<% =ServerValue1 %>" type="text">
                                                            </div>
