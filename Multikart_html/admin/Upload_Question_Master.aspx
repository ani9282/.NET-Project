            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    ...
                                    <div class="col-xl-7">
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="form-group  mb-3 row">                                                                                            
                                                    ...
                                                    <asp:TextBox ID="tb_ChapterNo" class="form-control col-xl-8 col-sm-7" Enabled="false" Ontextchanged="tb_ChapterNo_OnTextChanged" autopostback="true" runat="server"></asp:TextBox>                                                                                                                      
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                ...
                                                <div class="form-group  mb-3 row">                                                                                            
                                                    ...
                                                    <asp:TextBox ID="tb_Que_No" class="form-control col-xl-8 col-sm-7" Enabled="false" runat="server"></asp:TextBox>                                                                                                                      
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>

                                                 <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Que_Name" class="col-xl-3 col-sm-4 mb-0">Question Name:</label>
                                                    <asp:TextBox ID="tb_Question_Name"  runat="server" TextMode="MultiLine" Width="600px" Height="100px"></asp:TextBox>                                                                                                                      
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>

                                               <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Option" class="col-xl-3 col-sm-4 mb-0">Option A:</label>
                                                   <asp:TextBox ID="tb_Option_A"   Width="600px" Height="100px" runat="server" TextMode="MultiLine"></asp:TextBox>                                                                                                                                                                                                                                                                                                                                                                                               
                                                   <div class="valid-feedback">Looks good!</div>
                                                </div>

                                                <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Option" class="col-xl-3 col-sm-4 mb-0">Option B</label>                                                   
                                                   <asp:TextBox ID="tb_Option_B"    Width="600px" Height="100px" runat="server" TextMode="MultiLine"></asp:TextBox>                                                                                                                                                                                                                                                                                                                                                                                              
                                                   <div class="valid-feedback">Looks good!</div>
                                                </div>

                                                 <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Option" class="col-xl-3 col-sm-4 mb-0">Option C</label>                                                   
                                                   <asp:TextBox ID="tb_Option_C"    Width="600px" Height="100px" runat="server" TextMode="MultiLine"></asp:TextBox>                                                                                                                                                                                                                                                                                                                                                                                              
                                                   <div class="valid-feedback">Looks good!</div>
                                                </div>

                                                 <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Option" class="col-xl-3 col-sm-4 mb-0">Option D</label>                                                   
                                                   <asp:TextBox ID="tb_Option_D"   Width="600px" Height="100px" runat="server" TextMode="MultiLine"></asp:TextBox>                                                                                                                                                                                                                                                                                                                                                                                              
                                                   <div class="valid-feedback">Looks good!</div>
                                                </div>

                                                <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Correct_Ans" class="col-xl-3 col-sm-4 mb-0">Correct Ans:</label>
                                                    <asp:TextBox ID="tb_Correct_Ans"  Width="600px" Height="100px" runat="server" TextMode="MultiLine"></asp:TextBox>                                                                                                                      
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                               
                                                <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Explaination" class="col-xl-3 col-sm-4 mb-0">Explanation:</label>
                                                    <asp:TextBox ID="tb_Explaination"  Width="600px" Height="100px" runat="server" TextMode="MultiLine"></asp:TextBox>                                                                                                                      
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                    ...
                                    <div class="clsmargin" style="margin-top: 5%; text-align: left;">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkbtnEdit" CommandName="lnkbtnEdit" CommandArgument='<%#Eval("Question_No")%>' runat="server">Edit</asp:LinkButton>
                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("Question_No")%>' runat="server">Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
