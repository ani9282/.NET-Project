...
<body>
    ...
    <section class="register-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>Update Student Register Data</h3>
                    <div class="theme-card">
                        <form runat="server" class="theme-form">
                            <div class="form-row">
                                <div class="col-md-3">
                                    <label for="lbl_Stud_ID">Student ID</label>
                                    <asp:TextBox ID="tb_Stud_ID" class="form-control" placeholder="Student ID" autopostback="true" runat="server"  required=""></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-3">
                                    <label for="lbl_F_Name">Student First Name</label>
                                     <asp:TextBox ID="tb_Stud_First_Name" class="form-control" placeholder="Student First Name" autopostback="true" runat="server"  required=""></asp:TextBox>
                                </div>

                                <div class="col-md-3">
                                    <label for="lbl_M_Name">Student Middle Name</label>
                                     <asp:TextBox ID="tb_Stud_Middle_Name" class="form-control" placeholder="Student Middle Name" autopostback="true" runat="server"  required=""></asp:TextBox>
                                </div>

                                <div class="col-md-3">
                                    <label for="lbl_L_Name">Student Last Name</label>
                                     <asp:TextBox ID="tb_Stud_Last_Name" class="form-control" placeholder="Student Last Name" autopostback="true" runat="server"  required=""></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label for="lbl_Standard">Standard</label>
                                     <asp:TextBox ID="tb_Standard" class="form-control" placeholder="Standard" runat="server" autopostback="true" required=""></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label for="lbl_Mob_No">Mobile Number</label>
                                    <asp:TextBox ID="tb_MoileNo" class="form-control" placeholder="Student Mobile Number" autopostback="true" runat="server" maxlength="10" required=""></asp:TextBox> 
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
