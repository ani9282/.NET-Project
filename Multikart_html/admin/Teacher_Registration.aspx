<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teacher_Registration.aspx.cs" Inherits="admin_Teacher_Registration" %>
                                ...
                                <!--<div class="col-md-3">-->
                                 <div class="col-xl-7">
                                    ...
                                    <!--<input type="Text" class="form-control" id="tb_Stud_ID" name="Stud_ID" placeholder="Student ID"
                                        required="">-->
                                    <asp:TextBox ID="tb_Teacher_ID" class="form-control" Enabled="false" placeholder="Teacher ID" runat="server"  required=""></asp:TextBox>
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-md-3">
                                    <label for="lbl_F_Name">Teacher First Name</label>
                                     <asp:TextBox ID="tb_Teacher_First_Name" class="form-control" placeholder="Teacher First Name" runat="server"  required=""></asp:TextBox>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>

                                <div class="col-md-3">
                                    <label for="lbl_M_Name">Teacher Middle Name</label>
                                     <asp:TextBox ID="tb_Teacher_Middle_Name" class="form-control" placeholder="Teacher Name" runat="server"  required=""></asp:TextBox>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>

                                <div class="col-md-3">
                                    <label for="lbl_L_Name">Student Last Name</label>
                                     <asp:TextBox ID="tb_Teacher_Last_Name" class="form-control" placeholder="Teacher Last Name" runat="server"  required=""></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group mb-3 row">
                                <div class="col-md-3">
                                    ...
                                    <asp:DropDownList ID="DDL_Subject" CssClass="form-control col-xl-9 col-sm-10" placeholder="Subject" runat="server" required="">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-md-3">
                                    <label for="lbl_Mob_No">Mobile Number</label>
                                     <asp:TextBox ID="tb_MoileNo" class="form-control" placeholder="Teacher Mobile Number" runat="server" maxlength="10" required=""></asp:TextBox>
                                    <div class="valid-feedback">Looks good!</div>                              
                                </div>
                            </div>
                            <div class="form-group mb-3 row">
