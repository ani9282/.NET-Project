<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-prod.aspx.cs" Inherits="admin_add_prod" %>
...
<li><a class="sidebar-header" href="invoice.html"><i data-feather="archive"></i><span>Invoice</span></a>
        ...
        <div class="page-body">
            ...
            <!-- Container-fluid starts-->
            <div class="container-fluid">
                   <form runat="server" class="needs-validation add-product-form" novalidate="">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                                        ...
                                        <div class="add-product">
                                            <div class="row">
                                                <div class="col-xl-9 xl-50 col-sm-6 col-9">
                                                    <!--img src="../image/bricks.jpg" alt="" class="img-fluid image_zoom_1 blur-up lazyloaded"-->
                                                  
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="~/assets/images/pro/1-.jpg" CssClass="img-fluid image_zoom_1 blur-up lazyloaded" />
                                                </div>
                                    ...
                                    <div class="col-xl-7">
                                            ...
                                            <div class="form">
                                                <div class="form-group mb-3 row">
                                                 <label for="validationCustom01" class="col-xl-3 col-sm-4 mb-0">Select Category&nbsp;&nbsp;&nbsp;&nbsp; : </label>
                                                 
                                                <asp:DropDownList ID="ddlCustomers" CssClass="form-control col-xl-8 col-sm-7" height="40px" t runat="server"></asp:DropDownList>
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="form-group mb-3 row">
                                                    <label for="validationCustom01" class="col-xl-3 col-sm-4 mb-0">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</label>
                                                    <input class="form-control col-xl-8 col-sm-7" value="<%=this.name1 %>" id="validationCustom01" name="prod_name" type="text">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="form-group mb-3 row">
                                                    <label for="validationCustom02" class="col-xl-3 col-sm-4 mb-0">Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                                                    <input class="form-control col-xl-8 col-sm-7" value="<%=this.price1 %>" id="validationCustom02" name="prod_price" type="text">
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="form-group mb-3 row">
                                                    <ul class="file-upload-product">
                                                     <asp:FileUpload ID="FileUpload1" runat="server" name="prod_img" Width="211px"  />  
                                                     <asp:Button ID="Button3" runat="server" onclick="Button2_Click" Text="Upload" /> 
                                                       
                                                    </ul>
                                                </div>
                                                 <div class="form-group mb-3 row">
                                                    <!--<label ID="Label1" for="validationCustom03" class="col-xl-3 col-sm-4 mb-0">Upload image :</label>-->
                                                     <asp:Label ID="Label1" runat="server"></asp:Label>
                                                       
                                                    <!--<input type="file" id="FileUpload1" name="prod_img">-->
                                            ...
                                            <div class="offset-xl-3 offset-sm-4">
                                                <!--<button type="submit" class="btn btn-primary" onclick="addproduct_Click">Add</button>-->
                                                <asp:Button ID="Button1" CssClass="btn btn-primary" runat="server" OnClick="Button1_Click" Text="Add" />
