<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prod-list.aspx.cs" Inherits="admin_prod_list" %>
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li><a href="add-prod.aspx"><i class="fa fa-circle"></i>Add Product</a></li>
                                    <li><a href="prod-list.aspx"><i class="fa fa-circle"></i>product list</a></li>
            ...
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                 <form class="needs-validation" runat="server" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-header">
                                                    ...
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Product List</h5>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="ID">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%#Eval("prod_id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Product Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName1" runat="server" Text='<%#Eval("prod_name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Category Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName2" runat="server" Text='<%#Eval("prod_category") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkbtnEdit" CommandName="lnkbtnEdit" CommandArgument='<%#Eval("prod_id") %>' runat="server">Edit</asp:LinkButton>
                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("prod_id") %>' runat="server">Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
