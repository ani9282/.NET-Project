...
public partial class back_end_Category : System.Web.UI.Page
{
    ...
    public void getData()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select cat_id,cat_name from krs_category", con);
    ...
    protected void grdView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "lnkbtnEdit")
        {
            ...
            Response.Redirect("UpdateData.aspx?cat_id=" + id); /* Pass id in querystring for updating record */
        ...
        if (e.CommandName == "lnkbtnDelete")
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from krs_category where cat_id='" + id + "'", con);
            con.Open();
           cmd.ExecuteNonQuery();
           con.Close();
