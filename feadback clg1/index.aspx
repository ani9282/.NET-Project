...
<body>
    <header>
        ...
        <a href=" #"=#"><i class="fa fa-twitter"></i></a>
         <a href=" #"=#"><i style="margin-left:900px;" class="fa fa-phone">98765436465</i></a>
        <a href="#"><i class="fa fa-envelope">email</i></a>
    </header>
    <hr />
    <header1><marquee direction="right">Shri.Jaywantrao Bhosale Polytechnic K.M.Gad </marquee><img src="image/kmg2.jpg" width="124px" height="35px" style="margin-left:1200px" /></header1>
    <%--<header1><marquee>Shri.Jaywantrao Bhasale Polytechnic K.M.Gad</marquee><img src="image/kmg2.jpg" width="124px" height="35px" style="margin-left:900px;" /></header1>--%>
    
    
    <%--<div class="head">
        <marquee> Shri.Jaywantrao Bhasale Polytechnic K.M.Gad</marquee>

    </div>--%>
    <%--<header><marquee direction="right" scrollamount="10">Shri.Jaywantrao Bhasale Polytechnic K.M.Gad</marquee></header>
    --%><hr />


    <div class="custom-padding">
        <nav>
            <div class="logo"><font color="black"><img src="image/kmg5.png" style="width: 124px; height: 52px; margin-top: 0px"/></font></div>
            <ul class="menu-area">
