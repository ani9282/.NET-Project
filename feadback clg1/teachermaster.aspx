<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teachermaster.aspx.cs" Inherits="teachermaster" %>
...
<body>
    ...
    <div class="content">
     ...
     <tr>
        <th align="center" bgcolor="indigo" style="color: white" colspan="6"><h1><em>Teacher Master</em></h1></th>
     </tr>
     <tr>
     <th align="center" class="auto-style2">Teacher Id</th>
     <td>
...
<%--             <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" BackColor="#FF3300" ControlToValidate="txtteachername" ErrorMessage="*"></asp:RegularExpressionValidator>--%>
     ...
     <td>
         ...
         <td>
             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" BackColor="#FF3300" ControlToValidate="txtemailid" ErrorMessage="email address must be valid" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
               </td>
     </td>
     </tr>
           <tr>
     ...
     <td class="auto-style8">
          ...
          <asp:DropDownList ID="txtbrname" runat="server" DataSourceID="SqlDataSource3" DataTextField="branchname" DataValueField="branchname">
          </asp:DropDownList>
          <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:feedbackcollageConnectionString %>" SelectCommand="SELECT [branchname] FROM [branchmaster]"></asp:SqlDataSource>
     </td>
     </tr>
           <tr>
     ...
     <td>
          ...
          <asp:TextBox ID="txtusername" runat="server" Style="width:99%"></asp:TextBox>
           ...
           <tr>
     <th align="center" class="auto-style2">Password</th>   <td>
         ...
         <td><asp:Button ID="btngene" runat="server" Text="Generate password" 
                    Width="132px" Font-Bold="True" Height="31px" align="center" OnClick="btngene_Click1" BackColor="Silver" style="font-style: italic" /></td>
     </td>
     </tr>
         ...
         <td style="width: 131px; height: 42px;">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="274px" BorderStyle="Solid" style="margin-left: 290px" Width="838px">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" AllowPaging="True" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:feedbackcollageConnectionString %>" SelectCommand="SELECT * FROM [teachermaster]"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:feedbackcollageConnectionString %>" SelectCommand="SELECT * FROM [teachermaster]"></asp:SqlDataSource>
