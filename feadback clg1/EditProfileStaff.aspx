<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditProfileStaff.aspx.cs" Inherits="EditProfileStaff" %>
...
<body>
    ...
    <div class="content">
     ...
     <tr>
        <th align="center" bgcolor="indigo" style="color: white" colspan="6"><h1><em>Edit Profile</em></h1></th>
     </tr>
     <tr>
...
<%--             <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" BackColor="#FF3300" ControlToValidate="txtteachername" ErrorMessage="*"></asp:RegularExpressionValidator>--%>
     ...
     <td>
         ...
         <td>
             <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" BackColor="#FF3300" ControlToValidate="TextBox1" ErrorMessage="email address must be valid" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
               </td>
     </td>
     </tr>
           <tr>
