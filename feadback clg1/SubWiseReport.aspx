<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubWiseReport.aspx.cs" Inherits="SubWiseReport" %>
...
<body>
    ...
    <div class="content">
     ...
     <td class="auto-style4">
         ...
         <asp:DropDownList ID="DropDownList2" runat="server" DataTextField="subjectName" DataValueField="subjectName">
         </asp:DropDownList>
     </td>
         <td class="auto-style10">
             <asp:Button ID="Button2" runat="server" OnClick="Button2_Click1" Text="Get Subject" BackColor="Silver" style="font-style: italic; font-weight: 700" />
             </td>
         <%--<td>
...
&nbsp;
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="Button1" runat="server" Text="Show Report"  Height="36px" Width="124px" BackColor="#FFCCFF" style="font-style: italic; font-weight: 700" OnClick="Button1_Click1" />
