<%@ Page Language="C#" AutoEventWireup="true" CodeFile="typemaster.aspx.cs" Inherits="typemaster" %>
...
for (i = 0; i < dropdown.length; i++) {
  dropdown[i].addEventListener("click", function() {
    ...
    <div style="height: 805px; width: 1492px; margin-right: 142px;">
     ...
     <tr>
        <th align="center" bgcolor="Cyan" style="color: black" colspan="2" class="auto-style5"><h1 class="auto-style2">Type Master Information</h1></th>
     </tr>
              <tr>
     ...
     <th align="center" class="auto-style3">&nbsp;&nbsp;
            <asp:Label ID="Label3" runat="server" Text="Type Master Name"></asp:Label>
            </th>
