<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PathalogyTestResult.aspx.cs" Inherits="PathalogyTestResult" %>
...
<body>
    ...
    <div class="sidebar">
      ...
      <div class="dropdown-container">
           ...
           <a href="PatientregforPathology.aspx">Patient Master</a>
...
for (i = 0; i < dropdown.length; i++) {
  dropdown[i].addEventListener("click", function() {
    ...
    <form runat="server">
    <table border="4" align="center" cellpadding="3" cellspacing="2" style="height: 50px; width: 30%;">
     <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td align="center"><input type="text"  id="results2" value="<%= this.results2 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <td align="center"><input type="text" name="required3" size="10" value="11–18"  style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text"  id="results3" value="<%= this.results3 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <td align="center"><input type="text"  name="required4" size="10" value="39–54" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results4" value="<%= this.results4 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <tr>
    ...
    <td align="center"><input type="text" id="result5" value="<%= this.results5 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <td align="center"><input type="text" name="required6" size="10" value="140000–450000" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results6" value="<%= this.results6 %>" size="5" style="font-size:10pt;" readonly></td>
  ...
  <tr>
    ...
    <td align="center"><input type="text" id="results7" value="<%= this.results7 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <tr>
    ...
    <td align="center"><input type="text" id="results8" value="<%= this.results8 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <td align="center"><input type="text" name="required9" size="10" value="110–250" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results9" value="<%= this.results9 %>" size="5" style="font-size:10pt;" readonly></td>
  <td align="center"> <asp:Label ID="alert9" runat="server" Height="20px" Width="60px"></asp:Label></td>
   ...
   <td align="center"><input type="text" name="required10" size="10" value="23-29" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results10" value="<%= this.results10 %>" size="5" style="font-size:10pt;"></td>
  <td align="center"> <asp:Label ID="alert10" runat="server" Height="20px" Width="60px"></asp:Label></td>
   ...
   <tr>
    ...
    <td align="center"><input type="text" id="results11" value="<%= this.results11 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <td align="center"><input type="text" name="required12" size="10" value="1–2" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results12" value="<%= this.results12 %>" size="5" style="font-size:10pt;" readonly></td>
 ...
 <tr>
   ...
   <td align="center"><input type="text" name="required13" size="10" value=" 40–85" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results13" value="<%= this.results13 %>" size="5" style="font-size:10pt;" readonly></td>
  ...
  <tr>
    ...
    <td align="center"><input type="text" id="results14" value="<%= this.results14 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <tr>
    ...
    <td align="center"><input type="text" id="results15" value="<%= this.results15 %>" size="5" style="font-size:10pt;" readonly></td>
  <td align="center"> <asp:Label ID="alert15" runat="server" Height="20px" Width="60px"></asp:Label></td>
   ...
   <td align="center"><input type="text" name="required16" size="10" value="3.5-5.0" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results16" value="<%= this.results16 %>" size="5" style="font-size:10pt;" readonly></td>
  <td align="center"> <asp:Label ID="alert16" runat="server" Height="20px" Width="60px"></asp:Label></td>
   ...
   <td align="center"><input type="text" name="required17" size="10" value="0.2-1.4" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results17" value="<%= this.results17 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <tr>
    ...
    <td align="center"><input type="text" id="results18" value="<%= this.results18 %>" size="5" style="font-size:10pt;" readonly></td>
 <td align="center"> <asp:Label ID="alert18" runat="server" Height="20px" Width="60px"></asp:Label></td>
   ...
   <td align="center"><input type="text" name="required19" size="10" value="7-21" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results19" value="<%= this.results19 %>" size="5" style="font-size:10pt;" readonly></td>
  ...
  <tr>
   ...
   <td align="center"><input type="text" name="required20" size="10" value="29-33" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results20" value="<%= this.results20 %>" size="5" style="font-size:10pt;" readonly></td>
...
<table id="customers">
  ...
  <tr>
    ...
    <td align="center"><input type="text" id="results21" value="<%= this.results21 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <tr>
    ...
    <td align="center"><input type="text" id="results22" value="<%= this.results22%>" size="5" style="font-size:10pt;" readonly></td>
  <td align="center"> <asp:Label ID="alert22" runat="server" Height="20px" Width="60px"></asp:Label></td>
   ...
   <td align="center"><input type="text" name="required23" size="10" value="<130" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results23" value="<%= this.results23 %>" size="5" style="font-size:10pt;" readonly></td>
   ...
   <td style="center"><input type="text" name="required24" size="10" value="170" style="font-size:10pt;" readonly></td>
    <td align="center"><input type="text" id="results24" value="<%= this.results24 %>" size="5" style="font-size:10pt;" readonly></td>
