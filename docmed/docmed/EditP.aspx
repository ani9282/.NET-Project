...
for (i = 0; i < dropdown.length; i++) {
  dropdown[i].addEventListener("click", function() {
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        <br />
        <asp:Label ID="Label2" runat="server" Font-Size="X-Large" style="font-weight: 700; font-style: italic; font-size: xx-large; margin-top: 0px;" Text="Patient Profile" Height="44px" Width="467px"></asp:Label>
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        <table border="2" align="center" cellpadding="5" cellspacing="6" style="height: 476px; width: 63%;">
     <tr>
        <th align="center" bgcolor="Cyan" style="color: black" colspan="2" class="auto-style5"><h1 class="auto-style2">Edit Profile</h1></th>
     </tr>
              <tr>
     <th align="center" class="auto-style3">&nbsp;&nbsp;
            <asp:Label ID="Label10" runat="server" Text=" Enter Reg.Field No"></asp:Label>
            </th>
     <td class="auto-style4">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox1" runat="server" Height="29px" Width="262px"></asp:TextBox>
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Show Data" style="margin-left: 26px; margin-top: 0px;" BackColor="Fuchsia" Height="34px" />
     </td>
     </tr>
     <tr>
     <th align="center" class="auto-style3">&nbsp;&nbsp;
     ...
     <td class="auto-style4">
         <asp:TextBox ID="TextBox2" runat="server" Height="29px" Width="262px" style="margin-left: 0px" ReadOnly></asp:TextBox>
     </td>
     </tr>
     <tr>
     ...
     <td class="auto-style4">
          ...
          <asp:TextBox ID="TextBox10" name="age" runat="server" Height="29px" Width="262px"></asp:TextBox>
         </td>
     </tr>
    ...
    <tr>
     ...
     <td class="auto-style4">
          ...
          <asp:TextBox ID="TextBox11" name="age" runat="server" Height="29px" Width="262px"></asp:TextBox>
         </td>
     </tr>
    ...
    <tr>
     ...
     <td class="auto-style5">
        ...
        <tr>
              <th align="center" class="auto-style1">&nbsp;
            <asp:Label ID="Label12" runat="server" Text="Insurance"></asp:Label>
              &nbsp;&nbsp;&nbsp;&nbsp;</th>
     <td class="auto-style5">
        ...
        <br />
        <br />
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" style="margin-left: 0px" Text="Update" Width="171px" BackColor="Fuchsia" Height="39px" />
        <br />
