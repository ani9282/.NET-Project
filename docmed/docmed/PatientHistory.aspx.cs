...
public partial class PatientHistory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (dt2.Rows.Count > 0)
        {
           ...
           DropDownList1.SelectedItem.Value = dt2.Rows[0][4].ToString();
           DropDownList2.SelectedItem.Value = dt2.Rows[0][5].ToString();
            DropDownList3.SelectedItem.Value = dt2.Rows[0][6].ToString();
