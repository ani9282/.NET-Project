   ...
   <th align="center"  bgcolor="Cyan" style="color: black" colspan="2" class="auto-style5"><h5 class="auto-style2" align="center">Directions</h5></th>
    ...
    <tr>
     ...
     <td class="auto-style4">
        ...
        <br />
                <div class="left">
                                <asp:GridView ID="GridView2" runat="server"  class="panel3">
                                </asp:GridView>
                                <br>
                 </div>
       ...
       <div  class="left">
                <div id="login-column" class="col-md-6">
                                ...
                                <asp:GridView ID="GridView3" class="adjust" runat="server" AllowPaging="True" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Height="129px" Width="566px">
