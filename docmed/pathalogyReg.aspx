<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pathalogyReg.aspx.cs" Inherits="pathalogyReg" %>
  ...
  color:red;
   ...
   <%-- <div class="content" style="background-image: url('img/department/5.png'); background-size:950px,1000px ;background-repeat: no-repeat">
      --%>
        ...
        <h3 class="text-center text-white pt-5" > Pathalogy Registration&nbsp;</h3>
