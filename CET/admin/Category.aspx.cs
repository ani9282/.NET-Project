...
public partial class back_end_Category : System.Web.UI.Page
{
    ...
    public void getData()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select Subject_ID,Subject_Name from CET_tblSubject", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        string strQuery = "insert into CET_tblSubject(Subject_Name) values(@Subject_Name)";
        SqlCommand cmd = new SqlCommand(strQuery);
        cmd.Parameters.Add("@Subject_Name", SqlDbType.VarChar).Value = name;
    ...
    protected void grdView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "lnkbtnDelete")
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from CET_tblSubject where Subject_ID='" + id + "'", con);
            con.Open();
           cmd.ExecuteNonQuery();
           con.Close();
