<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionShow.aspx.cs" Inherits="admin_QuestionShow" %>
                                    ...
                                    <div class="col-xl-7">
                                          <div class="Form-group mb-3 row"> 
                                            <div>
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <asp:TextBox ID="tb_T_Marks"  CssClass="form-control digits col-xl-10 col-sm-12" runat="server" Enabled="false" Font-Size="Larger" ></asp:TextBox>
                                               &nbsp;&nbsp;
                                           ...
                                           <div>
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                               <asp:TextBox ID="tb_Q_PID"  CssClass="form-control digits col-xl-10 col-sm-12" runat="server" Enabled="false" Font-Size="Larger"></asp:TextBox>
                                                 &nbsp;
                                               &nbsp;<asp:Label ID="lbl_Total_Question" runat="server" Font-Bold="True" Font-Size="Larger"  Visible="false" Text="Total Question "></asp:Label>
                                                &nbsp;&nbsp;
                                                 <asp:TextBox ID="tb_T_Ques"  CssClass="form-control digits col-xl-10 col-sm-12" runat="server" Visible="false" Font-Size="Larger"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div>
                                              <asp:Label ID="lbl_QuestionShow" runat="server" Text="Question Show" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                              <asp:CheckBoxList ID="ChkbList_Question" runat="server" Font-Size="Larger" BorderColor="Black" BorderStyle="Groove" Width="310px"></asp:CheckBoxList>
                                        </div>
                                        <div>
                                              <br />
                                              <asp:Button ID="Btn_Save" runat="server" Text="Save" Font-Bold="True" Font-Size="Larger" Height="53px" OnClick="btn_View_Click"></asp:Button>
                                        </div>
