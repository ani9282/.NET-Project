<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditChapter.aspx.cs" Inherits="admin_EditChapter" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form name="form1" runat="server" class="theme-form" style="margin:auto; margin-left:0px; margin-top:0px">
                            <br />
                            <div class="form-row" style="display:none">
                                <div class="col-md-6" style="text-align:center">
                                                    <asp:DropDownList ID ="DropDownList1" CssClass="form-control"  Width="80%" AutoPostBack="true" runat="server" >
                                ...
                                <div class="col-md-6" style="text-align:center">
                                                    ...
                                                    <asp:DropDownList ID ="DropDownList2" CssClass="form-control" Width="80%" AutoPostBack="true" runat="server" >
                                                    </asp:DropDownList>
                                                </div>
                                </div>
                            <br />
                                <div style="width:80%; margin:auto; text-align:center; display:none">
                                      <button type="button" class="btn btn-primary" style="width:200px" >Show Data</button>
                                    </div>
                                <div class="table-responsive">

                                    <div class="clsmargin" style="margin-top:0px">
            
                                      <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False" OnRowCommand="grdView_RowCommand" BackColor="#DEBA84" BorderStyle="None" BorderColor="#DEBA84" BorderWidth="1px" CellPadding="3" CellSpacing="2">
                <Columns>
                    <asp:TemplateField HeaderText="Standarad">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%#Eval("Standard") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Subject Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName1" runat="server" Text='<%#Eval("Subject") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Chapter ID">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName2" runat="server" Text='<%#Eval("Chapter_ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Chapter Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName3" runat="server" Text='<%#Eval("ChapterName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
