<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Start_Exam.aspx.cs" Inherits="admin_Start_Exam" %>
                                ...
                                <div class="row product-adding">
                                    ...
                                    <div class="col-xl-7">
                                       ...
                                       <div>
                                            ...
                                            <asp:DropDownList ID="DDL_Standard" CssClass="form-control digits col-xl-5 col-sm-6" runat="server" Font-Bold="True" Font-Size="Large">
                                        ...
                                        <br />
                                        <div>
                                            <asp:Label ID="lbl_Subject" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" Text="Subject:"></asp:Label>
                                            <br />
                                            &nbsp;<asp:CheckBoxList ID="CheckList_Subject" runat="server" Height="16px" Font-Bold="True" Font-Size="X-Large" OnSelectedIndexChanged="CheckList_Subject_SelectedIndexChanged" AutoPostBack="true" BorderColor="#333333" BorderStyle="Groove">   
                                            </asp:CheckBoxList>
                                            <div class="valid-feedback">Looks good!</div>
                                        </div> 
                                       &nbsp;&nbsp;<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div>
                                            <asp:Label ID="lbl_Total_Marks" runat="server" class="col-xl-3 col-sm-4 mb-0" Text="Total Marks:" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                            <asp:TextBox ID="tb_TMarks" runat="server"  CssClass="form-control digits col-xl-3 col-sm-4" Font-Size="Larger" placeholder="Enter Total Marks" ></asp:TextBox>
                                             <div class="valid-feedback">Looks good!</div>
                                       </div>
                                        <br />
                                        <div>
                                            <asp:Label ID="lbl_Time" runat="server" class="col-xl-3 col-sm-4 mb-0" Text="Time:" Font-Bold="True"  Font-Size="Larger"></asp:Label>
                                            <asp:TextBox ID="tb_Time" runat="server" CssClass="form-control digits col-xl-3 col-sm-4" Font-Size="Larger" placeholder="Enter Time" Font-Bold="True"></asp:TextBox>                                    
                                       </div>
                                        <br />
                                        <div class="Form-group mb-3 row"> 
                                            <div>
                                                ...
                                                <asp:TextBox ID="tb_Physics"  CssClass="form-control digits col-xl-10 col-sm-12" placeholder="Enter Marks"   runat="server" Visible="false" AutoPostBack="true" Font-Size="Large"  value ="0"></asp:TextBox>
                                                <div class="valid-feedback">Looks good!</div>
                                                <br />
                                                ...
                                                <asp:TextBox ID="tb_Chemistry" CssClass="form-control digits col-xl-10 col-sm-12" placeholder="Enter Marks" runat="server" Visible="false"  Font-Size="Large" AutoPostBack="true" value ="0"></asp:TextBox>
                                                <div class="valid-feedback">Looks good!</div>
                                                <br />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <asp:TextBox ID="tb_Maths"  CssClass="form-control digits col-xl-10 col-sm-12"  placeholder="Enter Marks"  runat="server" Visible="false" Font-Size="Large" AutoPostBack="true" Text="0" ></asp:TextBox>
                                                <div class="valid-feedback">Looks good!</div>
                                                <br />
                                               <!-- </td>
                                                    <br />
                                                ...
                                                <asp:TextBox ID="tb_Biology"  CssClass="form-control digits col-xl-10 col-sm-12" placeholder="Enter Marks" runat="server" Font-Size="Large" Visible="false" AutoPostBack="true" Text="0"></asp:TextBox>
                                               <div class="valid-feedback">Looks good!</div>
                                               <br />
                                           </div>
