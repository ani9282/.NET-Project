<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionPaper_Generator.aspx.cs" Inherits="admin_QuestionPaper_Generator" %>
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Products</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li>
                                ...
                                <ul class="sidebar-submenu">
                                    <li><a href="category.aspx" class="active"><i class="fa fa-circle"></i>Category</a></li>
...
<li><a class="sidebar-header" href="invoice.html"><i data-feather="archive"></i><span>Invoice</span></a>
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btn_View" runat="server" BorderColor="#FF0066" CssClass="btn-btn-Primary" Font-Bold="True" Font-Size="X-Large" Height="53px" Text="View" Width="231px" BackColor="#FF33CC" />
        <br /><br />
        <br />
        <br />
                                    <div>
