            ...
            <div class="container-fluid">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Add New Subject</h5>
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <div class="form">
                                                            <div class="form-group">
                                                                ...
                                                                <label for="validationCustom01" class="mb-1">Subject Name :</label>
                                                                <input class="form-control" style="margin-left:0px" id="validationCustom01" name="cat" type="text">
                                                            </div>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="ID">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%#Eval("Subject_ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Category Name">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName" runat="server" Text='<%#Eval("Subject_Name") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkbtnEdit" CommandName="lnkbtnEdit" CommandArgument='<%#Eval("Subject_ID") %>' runat="server">Edit</asp:LinkButton>
                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("Subject_ID") %>' runat="server">Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                                     ...
                                     <div style="width:100%; margin:auto; text-align:center; justify-content: center; align-items: center">
                                         <button type="button" class="btn btn-primary" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add New Subject</button>
                                     </div>
                                </form>
                            </div>
                        </div>
