                                        ...
                                        <div class="modal-dialog" role="document" style="width:80%; margin:auto">
                                            <div class="modal-content" style="width:80%; margin:auto">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Update Subject </h5>
                                                </div>
                                                <div class="modal-body">
                                                        ...
                                                        <div class="form">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" id="validationCustom01" style="margin-left:0px" name="cat" value="<% =ServerValue %>" type="text">
                                                            </div>
