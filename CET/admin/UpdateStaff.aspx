<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateStaff.aspx.cs" Inherits="admin_UpdateStaff" %>
                        ...
                        <form name="form1" runat="server" class="theme-form">
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="fname" name="fname" value="<% =SFName %>" placeholder="First Name"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="lname" name="mname" placeholder="Middle Name"
                                        required=""  style="margin-left:0px" value="<% =SMName %>">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                                    
                                    <input type="text" class="form-control" id="email" name="lname" placeholder="Last Name" required=""  style="margin-left:0px" value="<% =SLName %>">
                                </div>


                                <div class="col-md-6">
                                   <asp:DropDownList ID ="DropDownList1" CssClass="form-control" Width="370px" Height="50px" runat="server" style="margin-left:0px">
                             ...
                             <div class="form-row">
                                <div class="col-md-6">
                                    <br />
                                     ...
                                     <input class="form-control" id="email1" name="email" placeholder="Mobile Number" required="" onkeypress="return allowOnlyNumber(event);"  style="margin-left:0px" value="<% =MNo %>">
                                ...
                                <div class="col-md-6">
                                  <br />
                                    <input class="form-control" id="address" name="address" placeholder="Enter Address" required="" style="margin-left:0px" value="<% =Address %>">
                             ...
                             <div class="form-row">
                                <div class="col-md-6">
                                    <br />
                                     ...
                                     <input class="form-control" id="id" name="id" placeholder="Enter Student ID" required="" onkeypress="return allowOnlyNumber(event);"  style="margin-left:0px" value="<% =StudentID %>">
                                ...
                                <asp:Button ID="Button1" runat="server"    CssClass="btn btn-solid" 
                                   Text="Updte Account" OnClick="Button1_Click"/>
                            ...
                            <div class="marginleft" style="margin-top: 0%; text-align: left;">
                                ...
                                <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False" BackColor="White" BorderStyle="Solid" BorderColor="#999999" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" AllowPaging="True"
