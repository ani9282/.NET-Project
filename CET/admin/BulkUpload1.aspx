<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkUpload1.aspx.cs" EnableEventValidation="false" Inherits="admin_BulkUpload1" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 xl-50 col-sm-6 col-3">
                                                    <ul class="file-upload-product">
                                                        ...
                                                        CssClass="form-control digits col-xl-4 col-sm-5 mb-0"
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="offset-xl-3 offset-sm-5">
                                                <div class="form">
                                                    <div class="form-group mb-3 row">
                                                        <asp:Label ID="DropDoenList_Std" class="col-xl-4 col-sm-5 mb-0" runat="server"  Font-Size="Large">Standard :</asp:Label>
                                                        <asp:DropDownList ID="DDL_Std" CssClass="form-control digits col-xl-8 col-sm-7 mb-0" runat="server">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        <asp:Button ID="Btn_Physics" runat="server"  Height="50PX" Width="400px" OnClick="Btn_Physics_Click" Visible="false" BackColor="#9933FF" ForeColor="Black" />


                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                        <asp:Button ID="Btn_Chemistry" runat="server"  Height="50PX" Width="400px" OnClick="Btn_Chemistry_Click" BackColor="#66FF66" Type="text" Visible="false" />

                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                        <asp:Button ID="Btn_Maths" runat="server"  Height="50PX" Width="400px" BackColor="#6666FF" OnClick="Btn_Maths_Click" Type="text" Visible="false" ForeColor="Black" />

                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                        <asp:Button ID="Btn_Biology" runat="server"  Height="50PX" Width="400px" BackColor="#CC3399" OnClick="Btn_Biology_Click" Type="text" Visible="false" />
