<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QDisplay.aspx.cs" Inherits="admin_QDisplay" %>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                         ...
                         <div class="table-responsive"> 
                                           <div class="marginleft" style="margin-top: auto; text-align: left;">
                                         <asp:GridView ID="abc" AutoGenerateColumns="False" Style="border: #0000ff thick solid; margin-left: 3px;" runat="server" CellPadding="4" GridLines="None" Width="700px" Height="500px" ForeColor="#333333" OnRowCommand="grdView_RowCommand" OnSelectedIndexChanged="abc_SelectedIndexChanged">
                                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                <Columns>
                                                      <asp:TemplateField HeaderText="Actions">
                                                        <ItemTemplate>
                           
                                                            <asp:LinkButton ID="lnkbtnDelete" CommandName="lnkbtnDelete" CommandArgument='<%#Eval("Standard")+","+ Eval("Subject")+","+ Eval("Chapter_No")+","+ Eval("Chapter_Name")+","+ Eval("Question_Name")+","+ Eval("Question_No")+","+ Eval("Option_A")+","+ Eval("Option_B")+","+ Eval("Option_C")+","+ Eval("Option_D")+","+ Eval("Correct_Ans")+","+ Eval("Explanation")+","+ Eval("Q_ID") %>' runat="server">Select</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    ...
                                    <div style="width:100%; margin:auto; text-align:center; justify-content: center; align-items: center">
                                        <br />
                                        <asp:Button ID="btn_View" runat="server" CssClass="btn btn-info btn-md" Text="Save" OnClick="btn_View_Click" />
                                    </div>
