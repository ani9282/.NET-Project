<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chapter_Displayaspx.aspx.cs" Inherits="admin_Chapter_Displayaspx" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    ...
                                    <div class="col-xl-7">
                                        ...
                                        <div class="Form-group mb-3 row"> 
                                           ...
                                           <div>
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                               <asp:TextBox ID="tb_Q_PID"  CssClass="form-control digits col-xl-10 col-sm-12" runat="server" Font-Size="Larger" Enabled="false"></asp:TextBox>
                                                 &nbsp;
                                               &nbsp;<asp:Label ID="lbl_Total_Question" runat="server" Font-Bold="True" Font-Size="Larger" Visible="false" Text="Total Question "></asp:Label>
                                                &nbsp;&nbsp;
                                                 <asp:TextBox ID="tb_T_Ques" CssClass="form-control digits col-xl-10 col-sm-12"  AutoPostBack="True" OnTextChanged="tb_T_Ques_TextChanged" Visible="false" runat="server" Font-Size="Larger"></asp:TextBox>
                                            </div>
                                        </div>

                                        <div>
                                            <asp:Label ID="lbl_Standard" runat="server"  Font-Bold="True" Font-Italic="True" Font-Size="X-Large" Text="Standard:"></asp:Label>
                                            <asp:TextBox ID="tb_Standard" CssClass="form-control digits col-xl-4 col-sm-5" Enabled="false" runat="server"></asp:TextBox>
                                     ...
                                     <div class="Form-group mb-3 row"> 
                                       ...
                                       <div class="table-responsive"> 
                                         ...
                                         <asp:GridView ID="GDV_Chapter_Show" AutoGenerateColumns="False" Style="border: #0000ff thick solid; margin-left: 3px;" runat="server" CellPadding="4" GridLines="None" Width="461px" ForeColor="#333333">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                                        <asp:Button ID="btn_View" runat="server" BorderColor="#FF0066" CssClass="btn-btn-Primary" Font-Bold="True" Font-Size="X-Large" Height="53px" Text="View" Width="231px" BackColor="#FF33CC" OnClick="btn_View_Click" />
                                        <br />
