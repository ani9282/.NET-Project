<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quetion_Show.aspx.cs" Inherits="admin_Quetion_Show" %>
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                    ...
                                    <div class="col-xl-7">
                                        <div class=""col-md-6 ">
                                           <div>
                                                <asp:Label ID="lbl_Time" runat="server" Font-Size="Large" Font-Bold="True" Text="Time"></asp:Label>
                                                <asp:TextBox ID="tb_Time" CssClass="form-control digits col-xl-3 col-sm-4" runat="server"></asp:TextBox>
                                            </div>
                                            <br />
                                            <div>
                                                <asp:Label ID="lbl_T_Marks" runat="server" Font-Size="Large" Font-Bold="True" Text="Total Marks"></asp:Label>
                                                <asp:TextBox ID="tb_T_Marks" CssClass="form-control digits col-xl-3 col-sm-4" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div>
                                          <asp:Label ID="lbl_QP_ID" runat="server" Font-Size="Large" Font-Bold="True" Text="Question Paper ID"></asp:Label>
                                           <asp:TextBox ID="tb_QP_ID" CssClass="form-control digits col-xl-3 col-sm-4" runat="server"></asp:TextBox>
                                        </div>
                                        <div>
                                          <asp:Label ID="NO_Of_Question"  runat="server" Font-Size="Large" Font-Bold="True" Text="Total Number Question"></asp:Label>
                                          <asp:TextBox ID="tb_Q_No" CssClass="form-control digits col-xl-3 col-sm-4" runat="server"></asp:TextBox>
                                        </div>
                                        <div>
                                           <asp:Label ID="lbl_Std"  runat="server" Font-Size="Large" Font-Bold="True" Text="Standard"></asp:Label>
                                          <asp:TextBox ID="tb_Std" CssClass="form-control digits col-xl-3 col-sm-4" runat="server"></asp:TextBox>
                                        </div>
                                        <div>
                                       ...
                                       <div>
                                         <asp:GridView ID="GDV_Chapter_Show" AutoGenerateColumns="False" Style="border: #0000ff thick solid;" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="779px">
                                                ...
                                                <Columns>
                                                   <asp:TemplateField HeaderText ="Select Item">
                                                    ...
                                                    <asp:TemplateField  HeaderText="Question Number">
                                                        <ItemTemplate>      
                                                            <asp:TextBox ID="tb_QNo" runat="server" Text='<%#Eval("Q_ID") %>' ></asp:TextBox>
                                                        </ItemTemplate>        
                                                    </asp:TemplateField>
                                                    <asp:TemplateField  HeaderText="Question Name">
                                                        <ItemTemplate>      
                                                            <asp:TextBox ID="tb_QName" runat="server" Text='<%#Eval("Question_Name") %>' TextMode="MultiLine"></asp:TextBox>
                                                        </ItemTemplate>        
                                                    </asp:TemplateField>
                                                    <asp:TemplateField  HeaderText="Total Marks">
                                                        <ItemTemplate>
                                                           <asp:TextBox ID="tb_TMarks" runat="server"></asp:TextBox>
                                                        </ItemTemplate>        
                                                    </asp:TemplateField>
                                                </Columns>
                                        ...
                                        <br />
                                        <div>
                                            <asp:Button ID="Btn_Submit" runat="server" Text="Save" BackColor="#FF0066" CssClass="btn-btn-Primary" Font-Bold="True" Font-Size="Larger"></asp:Button>
                                        </div>
