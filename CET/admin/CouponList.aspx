<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CouponList.aspx.cs" Inherits="admin_CouponList" %>
...
<head>
    ...
    <title>Maangalya Admin Template</title>
            ...
            <div class="container-fluid">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Title">
                        <ItemTemplate>
                            <asp:Label ID="lblID" runat="server" Text='<%#Eval("CouponCode") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Code">
                        <ItemTemplate>
                            <asp:Label ID="lblFullName" runat="server" Text='<%#Eval("CouponTitle") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Discount">
                        <ItemTemplate>
                              <asp:Label ID="lblFullName2" runat="server" Text='<%#Eval("Quantiy") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Status">
                        <ItemTemplate>
                              <asp:Label ID="lblFullName1" runat="server" Text='<%#Eval("Status") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
