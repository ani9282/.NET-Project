<% @ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Data.aspx.cs" Inherits="admin_Update_Data" %>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row product-adding">
                                   ...
                                   <div>
                                     ...
                                     <div>
                                            ...
                                            <asp:DropDownList ID="DDL_Standard" CssClass="form-control digits col-xl-3 col-sm-4" runat="server" Font-Bold="True" Font-Size="Large">
                                ...
                                &nbsp;<asp:CheckBoxList ID="CHKB_Subject" runat="server" class="col-xl-3 col-sm-4 mb-0" BorderStyle="Groove" BackColor="White" Font-Size="Larger" AutoPostBack="true" OnSelectedIndexChanged="CHKB_Subject_SelectedIndexChanged">
                                </asp:CheckBoxList>
                                     ...
                                     <div class="Form-group mb-3 row"> 
                                        ...
                                        <asp:Label ID="lbl_chapter" runat="server" Text="Chapter Name:" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        <asp:CheckBoxList ID="CHKB_chapter" runat="server" BorderColor="Black" Font-Size="Larger" Width="524px"></asp:CheckBoxList>
                                         <br />
                                        <asp:Label ID="lbl_Chapter_Show" runat="server" Text="Chapter Name Show:" Font-Bold="True" Font-Size="Larger"></asp:Label>
                                        <asp:CheckBoxList ID="ChkB_Chapter_Show" runat="server" BorderColor="Black" Font-Size="Larger" Width="524px"></asp:CheckBoxList>
                                     </div>
