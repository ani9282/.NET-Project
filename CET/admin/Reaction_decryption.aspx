<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reaction_decryption.aspx.cs" Inherits="admin_Reaction_decryption" %>
                                    ...
                                    <div class="col-xl-7">
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="Form-group mb-3 row">
                                                    <label for="lbl_standard" marginright="250px" class="col-xl-3 col-sm-4 mb-0">Question No:</label>
                                                    <asp:TextBox ID="tb_Standard" class="form-control col-xl-8 col-sm-7" Height="100px" Width="600px" marginright="300px" Enabled="false" runat="server"></asp:TextBox>
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                               
                                                <div class="form-group  mb-3 row">                                                                                            
                                                    <label for="lbl_Subject" class="col-xl-3 col-sm-4 mb-0">Question :</label>
                                                    <asp:TextBox ID="tb_Subject" class="form-control col-xl-8 col-sm-7" Height="100px" Width="600px" Enabled="false" runat="server"></asp:TextBox>                                                                                                                      
                                                    <div class="valid-feedback">Looks good!</div>
                                                </div>
                                                <div class="form-group  mb-3 row">    
                                                 ...
                                                 <div class="form-group  mb-3 row"> 
                                                      <input type="radio" id="option3" name="gender" value="male">
                                                      <label for="male"></label><br>                                                                                           
                                                </div>

                                                 <div class="form-group  mb-3 row">  
                                                      <input type="radio" id="option4" name="gender" value="male">
                                                      <label for="male"></label><br>                                                                                          
                                                </div>
