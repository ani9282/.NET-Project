<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddChapter.aspx.cs" Inherits="admin_AddChapter" %>
                                   ...
                                   <div class="col-xl-7">
                                            ...
                                            <div class="form">
                                                ...
                                                <div class="Form-group mb-3 row" >
                                                    ...
                                                    <asp:DropDownList ID="DropDownList1" CssClass="form-control"  OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="true" runat ="server">
                                             ...
                                             <div class="Form-group mb-3 row" >
                                                    ...
                                                    <asp:TextBox ID ="lbl_ChpterID" class="form-control " runat="server" type="text" autopostback="true" required="" placeholder="Chapter No"></asp:TextBox>
                                                    <div class="valid-feedback">Looks good!</div>
                                          ...
                                          <div class="Form-group mb-3 row" >
                                                    ...
                                                    <input class="form-control" id="validationCustomUsername" name="ChapterName" type="text" required="" placeholder="Add chapter Name">
