...
<div class="page-wrapper">
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body" style="margin-top:0%">
            ...
            <div class="container-fluid">
                <div class="card" style="max-width:1200px; margin-bottom:10px;">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                            <div class="page-header" style="margin-left:5%">
                                                <h5>Student Name : <b><%:Name %></b>
                                                    <h5>Standard : <b><%:Std %></b></h5>
                                                    <h5>Exam No : <b><%:ExamNo %></b></h5>
                                                </h5>
                                        </div>
                                        ...
                                        <div class="theme-card">
                                            <form name="form1" runat="server" class="theme-form">
                                                <div id="mainDIV" runat="server">
                                                    ...
                                                    <asp:GridView ID="abc" runat="server" CssClass="table table-hover table-striped" GridLines="None" BorderStyle="Dashed" style="border-collapse:collapse;">
                                                    </asp:GridView>
                                                        </div>
                                                     <div class="form-row" style=" margin:auto; text-align:center; justify-content: center; align-items: center; max-width:1000px;">
                                <!--<h5>Products Category</h5>-->
                                    <asp:Button ID="Button2" Width="25%" Visible="false" runat="server" Text="" CssClass="btn btn-info btn-md" OnClick="Button2_Click"/>
                            </div>
                                                </div>
                                            </form>
                                        </div>
