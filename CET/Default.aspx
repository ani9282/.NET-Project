                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user mr-2"></span>Student Login</a>
                                </li>
        ...
        <div class="body">
            ...
            <asp:Button ID="btnHide" runat="server" Text="Close" />
                                        ...
                                        <div class="form-group">
                                            <input required="" name="username" type="text" class="form-control" placeholder="Mobile No" style="margin-left:0px" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
