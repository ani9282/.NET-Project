...
<head>
    ...
    <title>Maangalaya Shopping Mall</title>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>Welcome to Our store Maangalya Shopping Mall</li>
                        ...
                        <ul class="header-dropdown">
                            ...
                            <li class="onhover-dropdown mobile-account">
                                ...
                                <ul class="onhover-show-div">
                                    ...
                                    <li><a href="Registration.aspx" data-lng="es">Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <h4>
                        Maangalaya Shopping Mall
                    </h4>
                   
                    <p>
                        For years, Maangalya Shopping Mall has been the household name offering a special range for every occasion. With several stores, it has a wide reach with sprawling showrooms in Warangal, Karimnagar, Siddipet and Hanmakonda. We have recently expanded our reach to the City of Pearls - Hyderabad. Our showrooms at Madeenaguda, Boduppal, Vanasthalipuram and Kukatpally offer ‘Special’ collections of sarees, ethnic wear and trendy apparels for Men, Women and Kids.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        <div>
                            <div>
                                <img src="../assets/team/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                        ...
                        <div>
                            <div>
                                <img src="../assets/team/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="../assets/team/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="../assets/team/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        ...
                        <div class="sub-title">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    <li>
                                        <i class="fa fa-map-marker"></i>Maangalya Shopping Mall
                                    </li>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p>
                                <i class="fa fa-copyright" aria-hidden="true"></i> 2020 powered by
                                Maangalya
                            </p>
                        </div>
                    </div>
