                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo"><a href="index.html"><img src="../assets/M.jpeg"
                     ...
                     <div class="theme-form" >
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="fname"  readonly placeholder="Enter Your name" id="fname"
                                    required="" value="<%=Name %>"">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="last-name" name="lName" readonly placeholder="Enter Your Last Name" required="" value="<%=LName %>">
                            </div>
                            <div class="col-md-6">
                                <label for="review">Phone number</label>
                                <input type="text" class="form-control" id="review" name="mobile" placeholder="Enter your number"
                                    required="" value="<%=mobile%>"">
                            </div>
                            <div class="col-md-6">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" id="email" placeholder="Email" name="email" required="" readonly value="<%=email1 %>">
                            </div>
                            <div class="col-md-12">
                                <label for="review">Write Your Message</label>
                                <textarea class="form-control mb-0" name="msg" runat="server" placeholder="Write Your Message"
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="home" id="home" placeholder="company name"
                                    required="" value="<%=home1%>"">
                            </div>
                            <div class="col-md-6">
                                <label for="name">Address *</label>
                                <input type="text" class="form-control" id="address" name="address" placeholder="Address"
                                    required="" value="<%=address1%>"" >
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="city" name="city" placeholder="City" required="" value="<%=city1%>"">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="Button1" runat="server" CssClass="tn btn-sm btn-solid" OnClick="Button1_Click1" Text="Save Settings" />
                        ...
                        <div class="col-lg-6">
                            <div class="subscribe">
                                <div>
                                    ...
                                    <p>Never Miss Anything From Maangalaya By Signing Up To Our Newsletter.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i>2020 Powered By Maangalaya</p>
                        </div>
                    </div>
